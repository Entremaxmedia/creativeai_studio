#!/bin/bash
# Creative AI Edge Extension - Enterprise Force Install
# Run this once in Terminal: bash mac-install-edge.sh
# Edge will install and auto-update the extension automatically.

set -e

EXT_ENTRY="kililjbikhljfpjibnpnmjhdkapkfimm;https://entremaxmedia.github.io/creativeai_studio/updates.xml"

echo "Installing Creative AI extension policy for Microsoft Edge..."
...
plist_path = os.path.join(pref_dir, 'com.microsoft.Edge.plist')
...
echo ""
echo "Done! Quit Edge completely and reopen it."
