#!/bin/bash
# Creative AI Chrome Extension - Enterprise Force Install
# Run this once in Terminal: bash mac-install.sh
# Chrome will install and auto-update the extension automatically.

set -e

EXT_ENTRY="kililjbikhljfpjibnpnmjhdkapkfimm;https://entremaxmedia.github.io/creativeai_studio/updates.xml"

echo "Installing Creative AI extension policy..."
...
plist_path = os.path.join(pref_dir, 'com.google.Chrome.plist')
...
echo ""
echo "Done! Quit Chrome completely and reopen it."
